function [data,c_units,isConv,ylab] = marvl_getmodelpolylinedata_dist(rawData,filename,shp,varname,d_data,config,def,tim,mod)
...
X=d_data(mod).all_cellsX;
Y=d_data(mod).all_cellsY;
