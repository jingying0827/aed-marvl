...
hcbar=mycolor(ax(3),scales.(var_sheet), 'location','Southoutside');	
set(hcbar,'ytick',scaletick.(var_sheet));	
set(hcbar,'yticklabel',num2str(scaletick.(var_sheet)'*scalefactor.(var_sheet),'%.1f'));	
...
hcbar=mycolor(ax(4),scales.(var_curt),'location','Southoutside');	
set(hcbar,'ytick',scaletick.(var_curt));	
set(hcbar,'yticklabel',num2str(scaletick.(var_curt)'*scalefactor.(var_curt),'%.1f'));	
