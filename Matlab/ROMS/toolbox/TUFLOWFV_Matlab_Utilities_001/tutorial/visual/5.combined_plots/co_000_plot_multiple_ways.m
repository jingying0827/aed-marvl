...
tfv_profile = '../../../../Complete_Model/TUFLOWFV/results/HYD_002_PROFILES.nc';  
...
var_sheet       = 'V';                                                       % 2D or 3D variable from file e.g. H, V, TEMP, SAL, RHOW
var_curt        = 'V';                                                       % 3D variable from file e.g. V, TEMP, SAL, RHOW

% Titles
long_names  = {'Current Magnitude [m/s]';
               'Current Magnitude [m/s]';
               'Current Magnitude [m/s]';
               'Current Magnitude [m/s]'} ;                                 % Title for the plots
...
% curtain settings
clim_curt   = [ 0 0.5];                                                     % Colour limits for curtain
...
if strcmpi(var_profile,'V')                                                 % Special case of V to get the magnitude of V_x and V_y
    ...
    data = TMP.(site_plot).(var_profile);
end
...
pos  = get(hcbar,'position');pos(2) = 0.05;pos(4) = 0.02;
set(hcbar,'Position',pos)
